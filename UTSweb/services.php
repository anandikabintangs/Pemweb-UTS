...
<head>
  ...
  <title>Services - Concept - Bootstrap 5 Portfolio Template</title>
      ...
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-11 col-lg-9 col-xl-7 col-xxl-6 text-center text-white">
            <h1 class="display-3 fw-bold mb-3">UDAH LU TENANG FC</h1>
            <p class="lead mb-0">Merupakan TIM Futsal Yang Berdiri Pada Tahun 2015.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
            <h2 class="mb-4 display-5 text-center">UDAH LU TENANG FC</h2>
            <p class="text-secondary mb-5 text-center lead fs-4">Merupakan Tim Profesional Yang Dapat Membantu Anda Dalam Meraih Prestasi.</p>
        ...
        <div class="row gy-5">
          <div class="col-12 col-sm-6 col-lg-4">
            <div class="text-center px-xl-2">
              ...
              <h5 class="m-2">Paket Juara</h5>
              <p class="m-0 text-secondary">Kami dapat membantu anda meraih prestasi di pertandingan yang akan anda ikuti.</p>
            </div>
          </div>
    ...
    <section class="py-5 py-md-8 py-xl-10">
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
            <h2 class="mb-4 display-5 text-center">UDAH LU TENANG FC</h2>
            <p class="text-secondary mb-5 text-center lead fs-4">Kami telah memenangkan penghargaan yang merupakan bukti nyata dari kemampuan kami. Termasuk medali penghargaan tim terbaik.</p>
            <hr class="w-50 mx-auto mb-5 mb-xl-9 border-dark-subtle">
          </div>
        </div>
      </div>
